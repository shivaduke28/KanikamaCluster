...
Shader "KanikamaCluster/KanikamaClusterStandardSurface"
{
    Properties
    {
        ...
        _Udon_LightmapArray("LightmapArray", 2DArray) = ""{}
        _Udon_LightmapIndArray("LightmapIndArray", 2DArray) = ""{}
        _Udon_LightmapCount("Lightmap Count", Float) = 0
        _KanikamaClusterColorTex("Color Texture", 2D) = "white" {}
    ...
    FallBack "Diffuse"
    CustomEditor "KanikamaCluster.Editor.KanikamaClusterStandardGUI"
}